...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified diceImg2;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified diceImg1;
- (IBAction)rollButtonPressed:(id _Nonnull)sender;
